function initializeMap() {
  ...
  if (typeof google === 'object' && typeof google.maps === 'object') {
    ...
    searchBox.addListener('places_changed', function() {
      ...
      placesMarkers = clearPlaceMarkers(placesMarkers);
...
function clearPlaceMarkers(placesMarkers)
{
...
function setMapBoundsVisibleMarkers() {
...
function createMapMarker(location) {
  ...
  setMapBounds(new google.maps.LatLng(lat, lng));
  markers.push(marker);
